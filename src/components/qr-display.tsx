  ...
  const actionButtons = (
    <>
      <Button
        ...
        // Open the full-screen counter display (same as the top-bar "Show QR").
        // DashboardClient (in the layout) listens for this event.
        onClick={() => window.dispatchEvent(new Event("bs:open-present"))}
        className={
