        ...
        <article>
          <header className="mb-12">
            ...
            <p className="mt-4 text-lg leading-relaxed text-stone-500">
              ...
              hundreds of them. Here&apos;s why the paper stamp card is costing
              you regulars — and what actually works in 2026.
            </p>
          </header>
              ...
              {[
                {
                  num: "1",
                  title: "They get lost",
                  text: "50-70% of loyalty cards are never redeemed — not because customers don't want the reward, but because they lose the card. A customer with 6 stamps who washes their jeans won't start over. They'll just quietly disengage.",
                },
                {
                  num: "2",
                  title: "Zero data",
                  text: "You don't know how many active loyalty customers you have, how often they visit, when they last came in, or whether frequency is increasing. You're running a loyalty program blind.",
                },
                {
                  num: "3",
                  title: "Fraud is trivial",
                  text: "Anyone with a similar stamp can fake a paper card. The stamps on eBay are generic enough that customers can stamp their own card at home. It only takes a few to make the program unprofitable.",
                },
                {
                  num: "4",
                  title: "Ongoing cost",
                  text: "Cards, stamps, stamp pads, replacements. It's not huge, but it's recurring and annoying — especially for a program you can't track or measure.",
                },
              ].map(({ num, title, text }) => (
                <div
                  key={num}
          ...
          <section className="mb-14 rounded-2xl bg-stone-100 p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-stone-600">
              This is the most common concern — and the answer is no. Customers
              don&apos;t love paper cards. They tolerate them. What they love
              is the free coffee. Give them a faster, easier way to earn it and
              they&apos;ll switch without blinking.
            </p>
            <p className="mt-4 text-base leading-relaxed text-stone-600">
