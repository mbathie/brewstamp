...
.pill{display:inline-block;font-size:11px;font-weight:600;padding:1px 7px;border-radius:20px;border:1px solid var(--border);color:var(--ink-2)}.pill.hot{color:var(--good);border-color:var(--good)}.pill.warn{color:var(--s2);border-color:var(--s2)}.pill.cold{color:var(--muted)}.lk{font-weight:650;letter-spacing:.02em}.lk.high{color:var(--good);border-color:var(--good);background:color-mix(in srgb,var(--good) 12%,transparent)}.lk.medium{color:var(--s2);border-color:var(--s2)}.lk.low{color:var(--muted)}.why{display:block;font-size:11px;color:var(--muted);white-space:nowrap;font-weight:400}
